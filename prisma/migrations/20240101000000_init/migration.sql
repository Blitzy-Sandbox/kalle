...
-- CreateTable
-- NOTE: Application database role MUST have INSERT + SELECT only.
-- No UPDATE or DELETE permitted on this table (R32: Immutable Audit Log).
-- After migration, run:
--   REVOKE UPDATE, DELETE ON "audit_logs" FROM your_app_role;
